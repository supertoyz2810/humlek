    ...
    <Card className="w-[300px]">
      <CardHeader>
        <div className="flex flex-row justify-between">
          <Badge className="w-1/3 bg-yellow-500 rounded-xl text-slate-900 hover:bg-yellow-200">
            Today pick
          </Badge>
          <span className="hover:text-yellow-100 text-yellow-300"><FaStar /></span>
        </div>
        ...
        <div className="flex flex-row gap-1 text-white">
          <span>#</span>
          <Badge className="w-auto bg-orange-800 rounded-xl text-slate-50 hover:bg-orange-600">
            Foods
          </Badge>
          <Badge className="w-auto bg-green-800 rounded-xl text-slate-50 hover:bg-green-600">
            Drinks
          </Badge>
        </div>
